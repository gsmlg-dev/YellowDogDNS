defmodule YellowDog.Mnesia.MnesiaException do
  alias __MODULE__

  # Don't raise this error manually, instead call `YellowDog.Mnesia.Error.normalize`
  # or `YellowDog.Mnesia.Error.raise_from` to raise these errors.
