defmodule YellowDog.Mnesia.Mnesia do
  @moduledoc false
  ...
  Reference: https://github.com/gsmlg-dev/gsmlg_umbrella/issues/2
  """
  defmacro call_and_catch(method, arguments \\ []) do
    quote(bind_quoted: [fun: method, args: arguments]) do
      ...
      try do
        ...
        :exit, error -> YellowDog.Mnesia.Error.raise_from_code(error)
      end
    end
  end
  ...
  of the YellowDog.Mnesia transaction methods are used).
  """
