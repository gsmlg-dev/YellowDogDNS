defmodule YellowDog.Socket.SSL do
  @moduledoc """
  ...
  * `:preferred_protocols` is a list of strings representing the preferred next
  ...
  `YellowDog.Socket.Manager` and it will be closed when there are no more references to
  it.
  """
  ...
  """
  @spec connect(
          {YellowDog.Socket.Address.t(), :inet.port_number()}
          | YellowDog.Socket.t()
          | YellowDog.Socket.Address.t(),
  ...
  """
  @spec accept(YellowDog.Socket.t() | t) :: {:ok, t} | {:error, term}
  def accept(self) do
    accept(self, [])
  end
  ...
  """
  @spec accept!(YellowDog.Socket.t() | t) :: t | no_return
  ...
  """
  @spec accept(YellowDog.Socket.t(), Keyword.t()) :: {:ok, t} | {:error, term}
  ...
  raising if an error occurs.
  """
  @spec accept!(YellowDog.Socket.t(), t | Keyword.t()) :: t | no_return
  ...
  """
  @spec options(t | :ssl.sslsocket(), Keyword.t()) :: :ok | {:error, YellowDog.Socket.Error.t()}
  ...
  def arguments(options) do
    ...
    YellowDog.Socket.TCP.arguments(global) ++
