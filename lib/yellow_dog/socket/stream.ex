defprotocol YellowDog.Socket.Stream.Protocol do
  @doc """
...
defmodule YellowDog.Socket.Stream do
  @type t :: YellowDog.Socket.Stream.Protocol.t()

  use YellowDog.Socket.Helpers
  import Kernel, except: [send: 2]

  defdelegate send(self, data), to: YellowDog.Socket.Stream.Protocol
  defbang(send(self, data), to: YellowDog.Socket.Stream.Protocol)

  defdelegate file(self, path), to: YellowDog.Socket.Stream.Protocol
  defbang(file(self, path), to: YellowDog.Socket.Stream.Protocol)
  defdelegate file(self, path, options), to: YellowDog.Socket.Stream.Protocol
  defbang(file(self, path, options), to: YellowDog.Socket.Stream.Protocol)

  defdelegate recv(self), to: YellowDog.Socket.Stream.Protocol
  defbang(recv(self), to: YellowDog.Socket.Stream.Protocol)
  defdelegate recv(self, length_or_options), to: YellowDog.Socket.Stream.Protocol
  defbang(recv(self, length_or_options), to: YellowDog.Socket.Stream.Protocol)
  defdelegate recv(self, length, options), to: YellowDog.Socket.Stream.Protocol
  defbang(recv(self, length, options), to: YellowDog.Socket.Stream.Protocol)

  defdelegate shutdown(self), to: YellowDog.Socket.Stream.Protocol
  defbang(shutdown(self), to: YellowDog.Socket.Stream.Protocol)
  defdelegate shutdown(self, how), to: YellowDog.Socket.Stream.Protocol
  defbang(shutdown(self, how), to: YellowDog.Socket.Stream.Protocol)

  defdelegate close(self), to: YellowDog.Socket.Stream.Protocol
  defbang(close(self), to: YellowDog.Socket.Stream.Protocol)
...
defimpl YellowDog.Socket.Stream.Protocol, for: Port do
...
defimpl YellowDog.Socket.Stream.Protocol, for: Tuple do
  require Record
